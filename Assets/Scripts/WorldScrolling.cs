    ...
    private int CalculatePositionOnAxis(float currentValue, bool horizontal){
        if(horizontal){
            if(currentValue >= 0){
                ...
                currentValue += 1;
                currentValue = terrainTileHorizontalCount + currentValue % terrainTileHorizontalCount;
            }
        }else{
            if(currentValue >= 0){
                ...
                currentValue += 1;
                currentValue = terrainTileVerticalCount + currentValue % terrainTileVerticalCount;
            }
        }
